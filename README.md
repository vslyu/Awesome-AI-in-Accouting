...
## Some awesome resouce for beginners to walk through LLM
* [**DeepLearning.AI Short Courses**](https://learn.deeplearning.ai/)-The series of courses will introduce the most popular tools and basic theory about 🤗 Prompting, 🤗 RAG, 🤗 Agent and 🤗 Finetuing related to large language models.  
  * Course Difficulty: easy
  * GPU computing hardware requirements: low
* [**HuggingFace NLP course**](https://huggingface.co/learn/nlp-course/)-This course will teach you about natural language processing (NLP) using libraries from the Hugging Face ecosystem — 🤗 Transformers, 🤗 Datasets, 🤗 Tokenizers, and 🤗 Accelerate — as well as the Hugging Face Hub. It’s completely free and without ads.
* [**HuggingFace Deep RL Course**](https://huggingface.co/learn/deep-rl-course)

* Stanford NLP open class：
  * [**CS124:From Languages to Information**](https://web.stanford.edu/class/cs124/)
...
## Code Assistant
  * [**Microsoft Copilot**](https://github.com/features/copilot)
    * [**Learning AI with GitHub Copilot**](https://learn.microsoft.com/en-us/shows/learning-ai-with-github-copilot/)-GitHub Copilot uses the OpenAI Codex to suggest code and entire functions in real-time, right from your editor. This course help developers quickly master the usage and best practices of GitHub Copilot. 
  * [**Amazon CodeWhisperer**](https://aws.amazon.com/codewhisperer/)
    * [**Learn Amazon CodeWhisperer in 16 Minutes**](https://www.youtube.com/watch?v=X8pxN8TLQ8o)
  * [**THUDM CodeGeeX**](https://codegeex.cn/)
    * [**CodeGeeX: A Multilingual Code Generation Model**](https://keg.cs.tsinghua.edu.cn/codegeex/)

## Data Processing
* [**alibaba/data-juicer**](https://github.com/alibaba/data-juicer)-A One-Stop Data Processing System for Large Language Models
* [**HumanSignal/Adala**](https://github.com/HumanSignal/Adala)-Autonomous DAta (Labeling) Agent framework
...
* [**zejunwang1/LLMTuner**](https://github.com/zejunwang1/LLMTuner)

## Agent
### survey
* [**Awesome-AI-Agents**](https://github.com/Jenqyang/Awesome-AI-Agents)-Build & use AI agents
### Agent Framework
* [**AutoGPT**](https://github.com/Significant-Gravitas/AutoGPT)-Build & use AI agents
...
## Evolutions
* [**Open LLM Leaderboard**](https://huggingface.co/spaces/HuggingFaceH4/open_llm_leaderboard)-Open LLM Leaderboard aims to track, rank and evaluate open LLMs and chatbots.
* [**alpaca_eval**](https://github.com/tatsu-lab/alpaca_eval)-An Automatic Evaluator for Instruction-following Language Models
* [**ceval**](https://github.com/hkust-nlp/ceval)-A comprehensive Chinese evaluation suite for foundation models. It consists of 13948 multi-choice questions spanning 52 diverse disciplines and four difficulty levels, as shown below. 